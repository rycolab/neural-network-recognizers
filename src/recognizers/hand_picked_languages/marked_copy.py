...
class MarkedCopy(WeightedLanguage):
    ...
    def with_length_range(self, length_range):
        return LengthRestrictedMarkedCopy(self, length_range)
    
class LengthRestrictedMarkedCopy(LengthRestrictedWeightedLanguage):
